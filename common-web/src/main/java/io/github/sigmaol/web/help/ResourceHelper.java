package io.github.sigmaol.web.help;
 ...
 * 资源工具类
 */
public class ResourceHelper extends org.springframework.util.ResourceUtils {
	...
	public static Resource getResource(String resourceLocation) throws IOException {
		...
		if (resourceLocation.startsWith(ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX)) {
			return SpringHelper.getContext().getResource(resourceLocation);
		}
