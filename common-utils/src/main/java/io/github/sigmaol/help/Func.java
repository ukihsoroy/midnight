...
public class Func {
	...
	public static String firstCharToLower(String str) {
		return StringHelper.lowerFirst(str);
	}
	...
	public static String firstCharToUpper(String str) {
		return StringHelper.upperFirst(str);
	}
	...
	public static boolean isBlank(@Nullable final CharSequence cs) {
		return StringHelper.isBlank(cs);
	}
	...
	public static boolean isNotBlank(@Nullable final CharSequence cs) {
		return StringHelper.isNotBlank(cs);
	}
	...
	public static boolean isAnyBlank(final CharSequence... css) {
		return StringHelper.isAnyBlank(css);
	}
	...
	public static boolean isNoneBlank(final CharSequence... css) {
		return StringHelper.isNoneBlank(css);
	}
	...
	public static boolean isArray(@Nullable Object obj) {
		return ObjectHelper.isArray(obj);
	}
	...
	public static boolean isEmpty(@Nullable Object[] array) {
		return ObjectHelper.isEmpty(array);
	}
	...
	public static boolean isNotEmpty(@Nullable Object[] array) {
		return ObjectHelper.isNotEmpty(array);
	}
	...
	public static boolean equalsSafe(@Nullable Object o1, @Nullable Object o2) {
		return ObjectHelper.nullSafeEquals(o1, o2);
	}
	...
	public static <T> boolean contains(@Nullable T[] array, final T element) {
		return CollectionHelper.contains(array, element);
	}
	...
	public static boolean contains(@Nullable Iterator<?> iterator, Object element) {
		return CollectionHelper.contains(iterator, element);
	}
	...
	public static boolean contains(@Nullable Enumeration<?> enumeration, Object element) {
		return CollectionHelper.contains(enumeration, element);
	}
	...
	public static boolean isNumeric(final CharSequence cs) {
		return StringHelper.isNumeric(cs);
	}
	...
	public static int toInt(final Object value) {
		return NumberHelper.toInt(String.valueOf(value));
	}
	...
	public static int toInt(final Object value, final int defaultValue) {
		return NumberHelper.toInt(String.valueOf(value), defaultValue);
	}
	...
	public static long toLong(final Object value) {
		return NumberHelper.toLong(String.valueOf(value));
	}
	...
	public static long toLong(final Object value, final long defaultValue) {
		return NumberHelper.toLong(String.valueOf(value), defaultValue);
	}
	...
	public static Double toDouble(Object value, Double defaultValue) {
		return NumberHelper.toDouble(String.valueOf(value), defaultValue);
	}
	...
	public static Float toFloat(Object value, Float defaultValue) {
		return NumberHelper.toFloat(String.valueOf(value), defaultValue);
	}
	...
	public static String to62String(long num) {
		return NumberHelper.to62String(num);
	}
	...
	public static String join(Collection<?> coll, String delim) {
		return StringHelper.join(coll, delim);
	}
	...
	public static String join(Object[] arr, String delim) {
		return StringHelper.join(arr, delim);
	}
	...
	public static String randomUUID() {
		return StringHelper.randomUUID();
	}
	...
	public static String random(int count) {
		return StringHelper.random(count);
	}
	...
	public static String random(int count, RandomType randomType) {
		return StringHelper.random(count, randomType);
	}
	...
	public static String md5Hex(final String data) {
		return DigestHelper.md5Hex(data);
	}
	...
	public static String md5Hex(final byte[] bytes) {
		return DigestHelper.md5Hex(bytes);
	}

	public static String sha1(String srcStr) {
		return DigestHelper.sha1(srcStr);
	}

	public static String sha256(String srcStr) {
		return DigestHelper.sha256(srcStr);
	}

	public static String sha384(String srcStr) {
		return DigestHelper.sha384(srcStr);
	}

	public static String sha512(String srcStr) {
		return DigestHelper.sha512(srcStr);
	}
	...
	public static String encrypt(String data) {
		return DigestHelper.encrypt(data);
	}
	...
	public static String encodeBase64(String value, Charset charset) {
		return Base64Helper.encode(value, charset);
	}
	...
	public static String encodeBase64UrlSafe(String value) {
		return Base64Helper.encodeUrlSafe(value);
	}
	...
	public static String encodeBase64UrlSafe(String value, Charset charset) {
		return Base64Helper.encodeUrlSafe(value, charset);
	}
	...
	public static String decodeBase64(String value, Charset charset) {
		return Base64Helper.decode(value, charset);
	}
	...
	public static String decodeBase64UrlSafe(String value) {
		return Base64Helper.decodeUrlSafe(value);
	}
	...
	public static String decodeBase64UrlSafe(String value, Charset charset) {
		return Base64Helper.decodeUrlSafe(value, charset);
	}
	...
	public static String toString(InputStream input) {
		return IoHelper.toString(input);
	}
	...
	public static String toString(@Nullable InputStream input, Charset charset) {
		return IoHelper.toString(input, charset);
	}
	...
	public static Date parseDate(String dateStr, String pattern) {
		return DateHelper.parse(dateStr, pattern);
	}
	...
	public static Date parse(String dateStr, ConcurrentDateFormat format) {
		return DateHelper.parse(dateStr, format);
	}
	...
	public static String formatDateTime(TemporalAccessor temporal) {
		return DateTimeHelper.formatDateTime(temporal);
	}
	...
	public static String formatDate(TemporalAccessor temporal) {
		return DateTimeHelper.formatDate(temporal);
	}
	...
	public static String formatTime(TemporalAccessor temporal) {
		return DateTimeHelper.formatTime(temporal);
	}
	...
	public static String format(TemporalAccessor temporal, String pattern) {
		return DateTimeHelper.format(temporal, pattern);
	}
	...
	public static TemporalAccessor parse(String dateStr, String pattern) {
		return DateTimeHelper.parse(dateStr, pattern);
	}
	...
	public static TemporalAccessor parse(String dateStr, DateTimeFormatter formatter) {
		return DateTimeHelper.parse(dateStr, formatter);
	}
	...
	public static MethodParameter getMethodParameter(Constructor<?> constructor, int parameterIndex) {
		return ClassHelper.getMethodParameter(constructor, parameterIndex);
	}
	...
	public static MethodParameter getMethodParameter(Method method, int parameterIndex) {
		return ClassHelper.getMethodParameter(method, parameterIndex);
	}
	...
	public static <A extends Annotation> A getAnnotation(Method method, Class<A> annotationType) {
		return ClassHelper.getAnnotation(method, annotationType);
	}
	...
	public static <T> T newInstance(Class<?> clazz) {
		return (T) BeanHelper.instantiateClass(clazz);
	}
	...
	public static <T> T newInstance(String clazzStr) {
		return BeanHelper.newInstance(clazzStr);
	}
	...
	public static Object getProperty(Object bean, String propertyName) {
		return BeanHelper.getProperty(bean, propertyName);
	}
	...
	public static void setProperty(Object bean, String propertyName, Object value) {
		BeanHelper.setProperty(bean, propertyName, value);
	}
	...
	public static <T> T clone(T source) {
		return BeanHelper.clone(source);
	}
	...
	public static <T> T copy(Object source, Class<T> clazz) {
		return BeanHelper.copy(source, clazz);
	}
	...
	public static void copy(Object source, Object targetBean) {
		BeanHelper.copy(source, targetBean);
	}
	...
	public static <T> T copyProperties(Object source, Class<T> clazz) throws BeansException {
		return BeanHelper.copyProperties(source, clazz);
	}
	...
	public static <T> T toBean(Map<String, Object> beanMap, Class<T> valueType) {
		return BeanHelper.toBean(beanMap, valueType);
	}
