 ...
 * 集合工具类
 */
public class CollectionHelper extends org.springframework.util.CollectionUtils {
	...
	public static <T> boolean contains(@Nullable T[] array, final T element) {
		...
		return Arrays.stream(array).anyMatch(x -> ObjectHelper.nullSafeEquals(x, element));
	}
