...
import io.github.sigmaol.support.StrFormatter;
import io.github.sigmaol.support.StrSpliter;
...
public class StringHelper extends org.springframework.util.StringUtils {
	...
	public static boolean isBlank(final CharSequence cs) {
		return !StringHelper.hasText(cs);
	}
	...
	public static boolean isAnyBlank(final CharSequence... css) {
		if (ObjectHelper.isEmpty(css)) {
			return true;
		}
		return Stream.of(css).anyMatch(StringHelper::isBlank);
	}
	...
	public static boolean isNoneBlank(final CharSequence... css) {
		...
		return Stream.of(css).allMatch(StringHelper::isNotBlank);
	}
	...
	public static String join(Collection<?> coll) {
		return StringHelper.collectionToCommaDelimitedString(coll);
	}
	...
	public static String join(Collection<?> coll, String delim) {
		return StringHelper.collectionToDelimitedString(coll, delim);
	}
	...
	public static String join(Object[] arr) {
		return StringHelper.arrayToCommaDelimitedString(arr);
	}
	...
	public static String join(Object[] arr, String delim) {
		return StringHelper.arrayToDelimitedString(arr, delim);
	}
	...
	public static String random(int count) {
		return StringHelper.random(count, RandomType.ALL);
	}
