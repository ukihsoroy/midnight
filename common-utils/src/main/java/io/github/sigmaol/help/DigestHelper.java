 ...
 */
public class DigestHelper extends org.springframework.util.DigestUtils {
	...
	public static String md5Hex(final String data) {
		return DigestHelper.md5DigestAsHex(data.getBytes(Charsets.UTF_8));
	}
	...
	public static String md5Hex(final byte[] bytes) {
		return DigestHelper.md5DigestAsHex(bytes);
	}
