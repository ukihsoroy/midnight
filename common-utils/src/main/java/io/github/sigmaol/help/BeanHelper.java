...
import io.github.sigmaol.support.BaseBeanCopier;
import io.github.sigmaol.support.BeanProperty;
...
public class BeanHelper extends org.springframework.beans.BeanUtils {
	...
	public static <T> T clone(T source) {
		return (T) BeanHelper.copy(source, source.getClass());
	}
	...
	public static <T> T copyProperties(Object source, Class<T> target) throws BeansException {
		...
		BeanHelper.copyProperties(source, to);
		return to;
	}
	...
	public static <T> T toBean(Map<String, Object> beanMap, Class<T> valueType) {
		T bean = BeanHelper.newInstance(valueType);
	...
	public static Object generator(Object superBean, BeanProperty... props) {
		...
		BeanHelper.copy(superBean, genBean);
		return genBean;
	}
