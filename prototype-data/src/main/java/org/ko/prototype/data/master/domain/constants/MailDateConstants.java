...
/**
 * 此文件由工具生成，请勿修改
 * 生成时间: 2018-02-24 11:26:43
 * 
 */
public final class MailDateConstants {
	...
	public static final class Columns {
		...
		public static final List<String> COLUMNS = Arrays.asList(new String[]{
			ID.toLowerCase()
			, EMAIL.toLowerCase()
			, SEND_TIME.toLowerCase()
			, SEND_COUNT.toLowerCase()
		...
		static{
			...
			fieldMap.put(SEND_COUNT, "sendCount");
