...
public final class SliderConstants {
	...
	public static final class Values {
		public static final class Block {
			public static final short Home = 1;			// 首页
			public static String convert(Short value){
				String text = String.valueOf(value);
				if(Short.valueOf(Home).equals(value)){
					text = "首页";
				}
				return text;
			}
		...
		public static Object serialize(String columnName, String text){
			if(Columns.BLOCK.equalsIgnoreCase(columnName)){
				return Block.convert(text);
			}
