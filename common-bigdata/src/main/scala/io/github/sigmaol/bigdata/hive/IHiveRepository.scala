package io.github.sigmaol.bigdata.hive

import io.github.sigmaol.bigdata.IRepository
import io.github.sigmaol.bigdata.enums.TableType
import io.github.sigmaol.bigdata.enums.TableType.TableTypeEnum

trait IHiveRepository[E, R] extends IRepository with Serializable {
