package io.github.sigmaol.bigdata.framework.hive

import io.github.sigmaol.bigdata.framework.Repositable
import io.github.sigmaol.bigdata.framework.enums.TableType
import io.github.sigmaol.bigdata.framework.enums.TableType.TableTypeEnum

trait THiveRepository[E, R] extends Repositable with Serializable {
