package io.github.sigmaol.bigdata.component.connector.realtime

import java.util.Properties

import io.github.sigmaol.bigdata.component.connector.realtime.sinks.{HBaseSink, KafkaSink, MysqlSink, RedisSink}
