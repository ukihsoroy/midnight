...
import org.ko.analysis.conf.exp.ValidateException;
import org.ko.analysis.core.help.MessageI18nUtil;
...
public class ValidatorHelper {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ValidatorHelper.class);
    ...
    public void intiMessageSource(MessageSource source) {
        ValidatorHelper.messageSource = source;
    }
